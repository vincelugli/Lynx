...
public class SignInActivity extends Activity implements LoaderCallbacks<Cursor> {
	...
	/**
	 * Use an AsyncTask to fetch the user's username addresses on a background
	 * thread, and update the username text field with results on the main UI
	 * thread.
	 */
	class SetupUsernameAutoCompleteTask extends
		...
		protected List<String> doInBackground(Void... voids) {
			...
			Cursor usernameCur = cr.query(
					ContactsContract.CommonDataKinds.Email.CONTENT_URI, null,
					null, null, null);
			while (usernameCur.moveToNext()) {
				String username = usernameCur
						.getString(usernameCur
